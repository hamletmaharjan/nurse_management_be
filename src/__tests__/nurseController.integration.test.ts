...
describe('Nurses', () => {
  // Tests User Login
  const token =
    'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NiwibmFtZSI6ImNhcmxvcyBjb25kaXQiLCJlbWFpbCI6ImNvbmRpdEBsaXZlLmNvbSIsImlhdCI6MTY3MTU5MTc5Mn0.S8Dk7nTGcMpB2HmD4tFUUOVuFd4JO2dMmp14ieQa1gw';
