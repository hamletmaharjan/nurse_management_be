...
export const updateRoundingManager = (
  req: any,
  res: Response,
  next: NextFunction,
) => {
  ...
  fetchRoundingManager()
    .then(data => {
      ...
      const roundingManager = { ...data, is_rounding_manager: false };
    ...
    .then(data => {
      const newRoundingManager = {
        ...data,
        is_rounding_manager: !data.is_rounding_manager,
      };
